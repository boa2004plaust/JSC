...
if opt.arch_cls_t == 'resnet50':
    cls_model_t = resnet50(num_classes=dataset_num_classes)
    name_t = opt.name.replace('resnet18', 'resnet50')
...
if opt.arch_cls_s == 'resnet18':
    ...
    cls_model_s = resnet18(num_classes=dataset_num_classes)
if opt.arch_cls_s == 'shufflenetv2':
    from models.shufflenetv2 import shufflenetv2
    cls_model_s = shufflenetv2(num_classes=dataset_num_classes)
